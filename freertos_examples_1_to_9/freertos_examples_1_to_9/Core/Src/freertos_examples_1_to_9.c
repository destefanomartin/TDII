...
int main_(void)
{
	...
	xTaskCreate(vTask2, (const char *) "Task2", (2 * configMINIMAL_STACK_SIZE),
...
int main_(void)
{
	...
	xTaskCreate(vTaskFunction, (const char *) "Task2", (2 * configMINIMAL_STACK_SIZE),
...
int main_(void)
{
	...
	xTaskCreate(vTaskFunction, (const char *) "Task1", (2 * configMINIMAL_STACK_SIZE),
...
int main_(void)
{
	...
	xTaskCreate(vContinuousProcessingTask, (const char *) "Task1", (2 * configMINIMAL_STACK_SIZE),
				(void *) pcTextForTask1, (tskIDLE_PRIORITY + 1UL), (xTaskHandle *) NULL);
	xTaskCreate(vContinuousProcessingTask, (const char *) "Task2", (2 * configMINIMAL_STACK_SIZE),
				(void *) pcTextForTask2, (tskIDLE_PRIORITY + 1UL), (xTaskHandle *) NULL);
...
int main_(void)
{
	 ...
	 * is also set to NULL. */
	xTaskCreate(vTask1, (const char *) "Task1", (2 * configMINIMAL_STACK_SIZE),
...
static void vTask2(void *pvParameters)
{
	...
	vPrintString(pcTaskName);
	vPrintString("About to delete itself\r\n");
